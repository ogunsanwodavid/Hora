...
function CreateTaskButton() {
  ...
  return (
    <Link
      to="/tasks/createtask"
      className="fixed right-[24px] bottom-[90px] space-y-4 flex flex-col items-center md:right-[calc((100%_-_700px)_/_2)] lg:absolute lg:bottom-[30px] lg:right-[32px] group"
    >
      {/**** Modal */}
      <section
